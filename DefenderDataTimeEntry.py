...
from ClioAPIAccess import ClioAPIHelper, get_access_keys
...
if name == "John": # add time entries via Clio API
    ...
    while True:
        ...
        activities = ClioActivities(access_keys[0], access_keys[1], attorney, start_date, end_date)

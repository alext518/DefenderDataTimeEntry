...
class MyCaseAPIHelper(BaseAPIHelper):
    def __init__(self, client_id, client_secret, attorney, redirect_uri=""):
        super().__init__(
            client_id,
            client_secret,
            attorney,
            ...
            api_url="https://external-integrations.mycase.com/v1",
